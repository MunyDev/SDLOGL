...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'nginx/html/index.data';
...
Module['FS_createPath']('/', 'asset', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_nginx/html/index.data');

    };
    Module['addRunDependency']('datafile_nginx/html/index.data');
 ...
 loadPackage({"files": [{"filename": "/asset/basic.fs", "start": 0, "end": 82, "audio": 0}, {"filename": "/asset/basic.vs", "start": 82, "end": 167, "audio": 0}], "remote_package_size": 167, "package_uuid": "10c00ed7-9bf5-4f96-b200-c1982bfbf702"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5320064,
    DYNAMIC_BASE = 5320064,
    DYNAMICTOP_PTR = 77152;
